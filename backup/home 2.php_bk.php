...
<h2 class="text_c pa_50p line_h24"><?php the_field('info_title',74); ?><br>
...
while($loop->have_posts()): $loop->the_post(); ?>
<div class="clearfix flt_l width_25p">
<div id=”post-<?php the_ID(); ?>”>
...
<div class="container content-wrapper pa_50p" id="
greeting">
...
<div class="container content-wrapper pa_50p">
